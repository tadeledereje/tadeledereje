                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="longtude" class="form-control" value="{{$property->longtude}}">
               ...
               @endforeach
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-4">
                                            ...
                                            <select name="amenitis_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                                ...
                                                <option value="{{$amenitie->amenitis_name}}" {{(in_array($amenitie->amenitis_name,$property_ami))?'selected' : ''}}>{{$amenitie->amenitis_name}}</option>
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_desc" class="form-control" id="exampleFormControlTextarea1" rows="3" > {{ $property->short_descp }}</textarea>
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        <label class="form-label">Long Description</label>
                                        <textarea  name="long_desc" class="form-control" name="tinymce" id="tinymceExample" rows="10" >{!! $property->long_descp !!}</textarea>
                                    </div>
                                </div><!-- Col -->
                                <div class="mb-3">
